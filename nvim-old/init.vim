...
" Goyo plugin makes text more readable when writing prose:
	map <leader>f :Goyo 90%x100% \| set bg=light \| set linebreak<CR>
...
" Open my bibliography file in split
	map <leader>b :vsplit<space>$BIB<CR>
...
" Configure vimwiki directory
	let g:vimwiki_list = [{
		...
		\ 'custom_wiki2html':	'~/.local/bin/wiki2html',
		\ 'template_ext': 		'.html',
		\ }]
	map <leader>x :w! \| :VimwikiAll2HTML<CR>
	let g:vimwiki_ext2syntax = {'.Rmd': 'markdown', '.rmd': 'markdown','.md': 'markdown', '.markdown': 'markdown', '.mdown': 'markdown'}

" Function for changing case of selected area
